        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 bg-black/40 backdrop-blur-sm">
            <div className="bg-[#0a0a19]/90 backdrop-blur-md border border-white/10 p-10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.8)] max-w-xl w-full text-center">
                ...
                <div className="flex flex-col gap-4 w-full">
                    <button onClick={() => handlePlay(true)} className="w-full flex justify-center items-center gap-3 py-4 px-4 text-xl font-black rounded-xl text-white bg-cyan-600 hover:bg-cyan-500 shadow-[0_0_15px_rgba(6,182,212,0.4)] hover:shadow-[0_0_25px_rgba(6,182,212,0.8)] transition-all">
                        <Cpu size={28} /> {t.vsCpu}
                    </button>
                    <button onClick={() => handlePlay(false)} className="w-full flex justify-center items-center gap-3 py-4 px-4 text-xl font-black rounded-xl text-white bg-pink-600 hover:bg-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.4)] hover:shadow-[0_0_25px_rgba(236,72,153,0.8)] transition-all">
                        <Gamepad2 size={28} /> {t.local}
                    </button>
                    <div className="h-px w-full bg-gray-800 my-2"></div>
                    <button onClick={() => setAppState('SETTINGS')} className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-gray-600 text-lg font-bold rounded-xl text-gray-300 hover:bg-gray-800 hover:text-white transition-all">
